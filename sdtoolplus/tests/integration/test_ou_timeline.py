...
from sdtoolplus.autogenerated_graphql_client import TestingCreateOrgUnitOrgUnitCreate, \
    OrganisationUnitUpdateInput, RAValidityInput
...
async def test_ou_timeline_http_triggered_sync(
    ...
    params = {
            ...
            "DepartmentUUIDIdentifier": "fa77c98f-3fed-4b3e-adbf-2f390bc8479f",
            "ActivationDate": "01.01.1",
...
<GetDepartment20111201 creationDateTime="2025-02-18T10:41:08">
  <RequestStructure>
    ...
    <DepartmentUUIDIdentifier>fa77c98f-3fed-4b3e-adbf-2f390bc8479f</DepartmentUUIDIdentifier>
...
"""
    ...
    respx_mock.get(
        "https://service.sd.dk/sdws/GetDepartment20111201?InstitutionIdentifier=II&DepartmentUUIDIdentifier=fa77c98f-3fed-4b3e-adbf-2f390bc8479f&ActivationDate=01.01.1&DeactivationDate=31.12.9999&DepartmentNameIndicator=True&PostalAddressIndicator=False&UUIDIndicator=True"
    ).respond(
    ...
    r = await test_client.post(
        ...
        params={
            "inst_id": "II",
            "org_unit": "fa77c98f-3fed-4b3e-adbf-2f390bc8479f"
        }
    )
