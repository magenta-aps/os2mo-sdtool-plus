...
from sdclient.responses import Department, GetDepartmentParentResponse, \
    DepartmentParent
...
from sdtoolplus.sd.tree import build_tree, _get_extra_nodes, build_extra_tree
...
def test_build_extra_tree(
    ...
    def mock_get_department_parent(query_params: GetDepartmentParentRequest) -> GetDepartmentParentResponse:
