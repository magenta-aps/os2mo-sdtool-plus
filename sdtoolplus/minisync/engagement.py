...
from sdtoolplus.mo.timelines.common import mo_end_to_datetime
...
from ..mo.timelines.engagement import get_engagement_filter
...
async def move_engagement(
    ...
    obj = one(
        eng.objects,
        too_short=EngagementNotFoundError,
        too_long=MoreThanOneEngagementError,
    )
    ...
    if not _is_active_in_entire_interval(
        ...
        raise EngagementNotActiveError()
