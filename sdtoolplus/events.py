...
async def _mo_engagement(
    ...
    allowed_engagement_types = await get_engagement_types_to_process(
        gql_client=gql_client, settings=settings
    )
    if mo_engagement_engagement_type_uuids.difference(allowed_engagement_types):
        ...
        logger.debug(
            "Engagement types",
            allowed_engagement_types=allowed_engagement_types,
            mo_engagement_engagement_type_uuids=mo_engagement_engagement_type_uuids,
        )
        return
