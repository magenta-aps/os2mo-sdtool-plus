...
async def get_all_sd_persons(
    ...
    institution_identifier: str,
    effective_date: date,
    sync_active_persons: bool,
    sync_passive_persons: bool,
    ...
    sd_response = await asyncio.to_thread(
        ...
        GetPersonRequest(
            ...
            EffectiveDate=effective_date,
            StatusActiveIndicator=sync_active_persons,
            StatusPassiveIndicator=sync_passive_persons,
            ContactInformationIndicator=contact_information,
            PostalAddressIndicator=postal_address,
        ),
    )
