...
class GraphQLClient(AsyncBaseClient):
    ...
    async def get_person_timeline(
        ...
        query = gql(
            """
            query GetPersonTimeline($uuid: UUID!, $to_date: DateTime = null, $from_date: DateTime = null) {
              employees(filter: {uuids: [$uuid], to_date: $to_date, from_date: $from_date}) {
                objects {
                  validities(end: $to_date, start: $from_date) {
                    addresses {
                      address_type {
                        user_key
                        scope
