...
from sdtoolplus.exceptions import class_not_found_error
from sdtoolplus.exceptions import more_than_one_class_error
from sdtoolplus.exceptions import more_than_one_engagement_error
from sdtoolplus.exceptions import more_than_one_leave_error
from sdtoolplus.exceptions import more_than_one_org_unit_error
from sdtoolplus.exceptions import more_than_one_pnumber_error
from sdtoolplus.exceptions import more_than_one_postal_address_error
from sdtoolplus.exceptions import org_unit_not_found_error
...
async def _get_class(
    ...
    current = one(
        ...
        too_short=class_not_found_error,
        too_long=more_than_one_class_error,
    ).current
...
async def get_ou_timeline(
    ...
    validities = one(
        objects,
        too_short=org_unit_not_found_error,
        too_long=more_than_one_org_unit_error,
    ).validities
...
async def get_pnumber_timeline(
    ...
    object_ = one(objects, too_long=more_than_one_pnumber_error)
...
async def get_postal_address_timeline(
    ...
    object_ = one(objects, too_long=more_than_one_postal_address_error)
...
async def get_engagement_timeline(
    ...
    object_ = one(objects, too_long=more_than_one_engagement_error)
...
async def get_leave_timeline(
    ...
    validities = one(objects, too_long=more_than_one_leave_error).validities
