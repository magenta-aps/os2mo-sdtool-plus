...
from sdtoolplus.autogenerated_graphql_client.get_person_validities import (
...
async def sync_person(
    ...
    sd_person: Person,
    mo_person_validities: GetPersonValiditiesEmployees,
    dry_run: bool,
) -> None:
    ...
    """
    mo_objects = only(mo_person_validities.objects)
    if mo_objects is None:
        await create_person(
            gql_client=gql_client,
            cpr=sd_person.cpr,
            givenname=sd_person.given_name,
            surname=sd_person.surname,
            dry_run=dry_run,
        )
        return
    ...
    if (
        ...
        await update_person(
            gql_client=gql_client,
            uuid=one(mo_person_validities.objects).uuid,
