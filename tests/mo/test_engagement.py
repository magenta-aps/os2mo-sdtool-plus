...
from sdtoolplus.models import Timeline, Active, POSITIVE_INFINITY
from tests.test_models import TODAY_START, TOMORROW_START, MINUS_INFINITY, \
    YESTERDAY_START, DAY_AFTER_TOMORROW_START
...
def test__is_active_in_entire_interval_returns_false_for_multiple_active_intervals():
    ...
    # Act + Assert
    assert _is_active_in_entire_interval(
