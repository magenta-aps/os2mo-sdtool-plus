...
async def test_ou_timeline_sync_filter_unit_below_payroll_root(
    ...
    respx_mock.get(
        f"https://service.sd.dk/sdws/GetDepartment20111201?InstitutionIdentifier=II&DepartmentUUIDIdentifier={str(unit_below_payroll_root)}&ActivationDate=01.01.0001&DeactivationDate=31.12.9999&ContactInformationIndicator=False&DepartmentNameIndicator=True&PostalAddressIndicator=False&UUIDIndicator=True"
    ).respond(
        content_type="text/xml;charset=UTF-8",
        content=sd_dep_resp,
    )
