...
from sdtoolplus.mo.timeline import _get_facet_class
...
async def test_ou_timeline_create_new_unit_with_addresses(
    test_client: AsyncClient,
    graphql_client: GraphQLClient,
    org_unit_type: OrgUnitUUID,
    org_unit_levels: dict[str, OrgUnitLevelUUID],
    ...
    sd_dep_resp = f"""<?xml version="1.0" encoding="UTF-8"?>
        <GetDepartment20111201 creationDateTime="2025-02-18T10:41:08">
          ...
          <Department>
            ...
            <DepartmentName>name1</DepartmentName>
            <PostalAddress>
              <StandardAddressIdentifier>Kung Fu Street 100</StandardAddressIdentifier>
              <PostalCode>1000</PostalCode>
              <DistrictName>Pladderballe</DistrictName>
          ...
          <Department>
            ...
            <DepartmentName>name1</DepartmentName>
            <PostalAddress>
              <StandardAddressIdentifier>Kung Fu Street 101</StandardAddressIdentifier>
              <PostalCode>1001</PostalCode>
              <DistrictName>Pladderby</DistrictName>
              <MunicipalityCode>2345</MunicipalityCode>
            </PostalAddress>
            <ProductionUnitIdentifier>1234567890</ProductionUnitIdentifier>
          </Department>
          <Department>
            ...
            <ContactInformation>
              ...
              <TelephoneNumberIdentifier>87654321</TelephoneNumberIdentifier>
            </ContactInformation>
            <ProductionUnitIdentifier>1234567890</ProductionUnitIdentifier>
          </Department>
        </GetDepartment20111201>
    ...
    postal_address = one(
        ...
        if address.address_type.user_key == "AdresseAPOSOrgUnit"
    )

    assert postal_address.name == "Kung Fu Street 100, 1000, Pladderballe"
    assert postal_address.user_key == postal_address.name == postal_address.value
    assert postal_address.address_type == postal_address_type_uuid
    assert postal_address.visibility.uuid == visibility_class_uuid
