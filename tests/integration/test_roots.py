...
async def test_roots(
    ...
    # Assert
    AA_unit = await graphql_client.get_org_unit_timeline(
        OrganisationUnitFilter(uuids=[AA_uuid], from_date=None, to_date=None)
    )
    ...
    BB_unit = await graphql_client.get_org_unit_timeline(
        OrganisationUnitFilter(
            uuids=[UUID("20000000-0000-0000-0000-000000000000")],
            from_date=None,
            to_date=None,
        )
    )
    ...
    CC_unit = await graphql_client.get_org_unit_timeline(
        OrganisationUnitFilter(uuids=[CC_uuid], from_date=None, to_date=None)
    )
    ...
    unknown = await graphql_client.get_org_unit_timeline(
        OrganisationUnitFilter(
            uuids=[OrgUnitUUID("0d505112-1241-4caa-8b8f-a9db5d6d5442")],
            from_date=None,
            to_date=None,
        )
    )
