...
async def test_move_engagement(
    ...
    assert _from_mo_end_datetime(interval_5.validity.to) == t5
    ...
    assert _from_mo_end_datetime(interval_6.validity.to) == t6
    ...
    assert _from_mo_end_datetime(interval_7.validity.to) == POSITIVE_INFINITY
...
async def test_move_engagement_to_infinity(
    ...
    assert _from_mo_end_datetime(interval_5.validity.to) == t6
    assert interval_5.extension_1 == "name5"
    assert interval_5.extension_2 == "dep4"
    assert interval_5.user_key == user_key
    assert interval_5.job_function.uuid == job_function_1234
    ...
    assert _from_mo_end_datetime(interval_6.validity.to) == POSITIVE_INFINITY
    assert interval_6.extension_1 == "name5"
    assert interval_6.extension_2 == "dep4"
    assert interval_6.user_key == user_key
